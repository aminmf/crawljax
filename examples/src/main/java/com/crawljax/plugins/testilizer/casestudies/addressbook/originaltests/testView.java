...
public class testView{
	...
	public void test() throws Exception {
        ...
        driver.findElement(By.xpath("html/body/div[1]/div[4]/form[2]/table/tbody/tr[2]/td[7]/a/img")).click();
		assertTrue(driver.findElement(By.xpath("html/body/div[1]/div[4]/b")).getText().contains("John Doe"));
	}
