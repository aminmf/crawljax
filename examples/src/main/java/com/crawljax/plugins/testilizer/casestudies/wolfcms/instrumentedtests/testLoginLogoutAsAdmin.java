...
public class testLoginLogoutAsAdmin {
    ...
    public void testLoginAsAdmin() throws Exception {
        ...
        com.crawljax.plugins.testsuiteextension.seleniuminstrumentor.SeleniumInstrumentor.assertionModeOff();
        com.crawljax.plugins.testsuiteextension.seleniuminstrumentor.SeleniumInstrumentor.assertionModeOn();
        assertTrue(driver.findElement(com.crawljax.plugins.testsuiteextension.seleniuminstrumentor.SeleniumInstrumentor.getBy(By.xpath("//div[@id='dialog']/form/div/label[@class='checkbox']"))).getText().matches("^Remember me for [\\s\\S][\\s\\S] minutes\\.$"));
        com.crawljax.plugins.testsuiteextension.seleniuminstrumentor.SeleniumInstrumentor.getAssertion("assertTrue(driver.findElement(By.xpath(\"//div[@id='dialog']/form/div/label[@class='checkbox']\")).getText().matches(\"^Remember me for [\\\\s\\\\S][\\\\s\\\\S] minutes\\\\.$\"))");
        com.crawljax.plugins.testsuiteextension.seleniuminstrumentor.SeleniumInstrumentor.assertionModeOff();
    }
