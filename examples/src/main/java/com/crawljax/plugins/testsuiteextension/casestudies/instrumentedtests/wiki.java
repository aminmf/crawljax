...
public class wiki {
    ...
    public void testWiki() throws Exception {
        ...
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.xpath("(//img[@alt='Properties'])[11]")), "click", "").click();
        ...
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.id("label_showWikiEditorToolbar_FALSE")), "click", "").click();
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.id("label_forcePreviewBeforeSaving_TRUE")), "click", "").click();
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.id("label_forcePreviewBeforeSaving_FALSE")), "click", "").click();
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.id("label_showWikiEditorToolbar_TRUE")), "click", "").click();
