...
public class TestPageAndSnippetUsage {
	...
	public void testPageAndSnippetUsage() throws Exception {
		...
		driver.findElement(By.partialLinkText("Selenium test page")).click();
		assertEquals("Selenium test page", driver.findElement(By.xpath("//div[@id='colmask']//div[@id='col1']/h2")).getText());
	}
