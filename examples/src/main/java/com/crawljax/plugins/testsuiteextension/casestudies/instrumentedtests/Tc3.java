...
public class Tc3 {
    ...
    public void testTc3() throws Exception {
        ...
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.linkText("Show/Hide")), "click", "").click();
        ...
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.linkText("View all my messages")), "click", "").click();
        // Warning: verifyTextPresent may require manual changes  
        try {
