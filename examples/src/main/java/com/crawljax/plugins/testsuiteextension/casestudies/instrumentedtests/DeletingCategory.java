...
public class DeletingCategory {
    ...
    public void testDeletingCategory() throws Exception {
        ...
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.xpath("(//img[@alt='Delete category'])[5]")), "click", "").click();
