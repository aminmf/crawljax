...
public class Manage {
    ...
    public void testManage() throws Exception {
        ...
        com.crawljax.plugins.testsuiteextension.instrumentor.SeleniumInstrumentor.getWebElement(driver.findElement(By.linkText("Manage administrator email notifications")), "click", "").click();
