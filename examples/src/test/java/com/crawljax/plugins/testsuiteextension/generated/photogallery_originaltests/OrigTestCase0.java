...
public class OrigTestCase0 {
	...
	public void testAddStoryAssert() throws Exception {
		...
		driver.findElement(By.cssSelector("input.submit")).click();
		if(!(driver.findElement(By.cssSelector("div.method")).getText().matches("^[\\s\\S]*Story \"Photos\" added succesfully![\\s\\S]*$"))){System.out.println(Thread.currentThread().getStackTrace()[1].getMethodName());  return;}
