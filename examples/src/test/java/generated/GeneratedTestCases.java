...
/*
 * Generated @ Tue Jan 07 12:18:14 PST 2014
 */
...
public class GeneratedTestCases {
	...
	public void method0(){
		try {
			...
			assertTrue(isElementPatternPresent("DIV","DIV", new ArrayList<String>(Arrays.asList("#text","TABLE","#text"))));
			assertTrue(isElementPatternPresent("DIV","DIV", new ArrayList<String>(Arrays.asList("#text","DIV","#text","DIV","#text"))));
			assertTrue(isElementPatternPresent("DIV","DIV", new ArrayList<String>(Arrays.asList("#text","DIV","#text"))));
	...
	public void method2(){
		try {
			...
			assertTrue(isElementPatternPresent("DIV","DIV", new ArrayList<String>(Arrays.asList("#text","TABLE","#text"))));
			assertTrue(isElementPresent(By.cssSelector("div.claroDialogBox.boxSuccess")));
			//From state 17 to state 12
			//Eventable{eventType=click, identification=xpath /HTML/BODY/DIV/DIV/DIV[2]/DIV[2]/UL/LI[3]/SPAN/A, element=Element{node=[A: null], tag=A, text=Logout, attributes={href=/claroline-1.11.7/index.php?logout=true, target=_top}}, source=StateVertexImpl{id=17, name=state17}, target=StateVertexImpl{id=12, name=state12}}
			driver.findElement(By.xpath("/HTML/BODY/DIV/DIV/DIV[2]/DIV[2]/UL/LI[3]/SPAN/A")).click();
			assertTrue(isElementPresent(By.tagName("DIV")));
			assertTrue(isElementPatternPresent("DIV","DIV", new ArrayList<String>(Arrays.asList("#text","DIV","#text","DIV","#text"))));
		} catch (Exception e) {
