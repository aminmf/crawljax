...
public class GeneratedTestCase4 {
	...
	public void method4(){
		try {
			...
			//Eventable{eventType=click, identification=xpath /HTML/BODY/CENTER/DIV/DIV/DIV[2]/TABLE/TBODY/TR/TD[3]/A, element=Element{node=[A: null], tag=A, text=Next, attributes={class=q, onclick=javascript:ss_next();}}, source=StateVertexImpl{id=33, name=state33}, target=StateVertexImpl{id=34, name=state34}}
			driver.findElement(By.xpath("/HTML/BODY/CENTER/DIV/DIV/DIV[2]/TABLE/TBODY/TR/TD[3]/A")).click();
			mutateDOMTree();
