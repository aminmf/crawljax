...
public class GeneratedTestCase16 {
	...
	public void method16(){
		try {
			...
			//From state 43 to state 102
			//Eventable{eventType=click, identification=xpath /HTML/BODY/DIV/DIV[2]/UL[4]/LI[6]/A, element=Element{node=[A: null], tag=A, text=Exercises, attributes={href=config_edit.php?config_code=CLQWZ}}, source=StateVertexImpl{id=43, name=state43}, target=StateVertexImpl{id=102, name=state102}}
			driver.findElement(By.xpath("/HTML/BODY/DIV/DIV[2]/UL[4]/LI[6]/A")).click();
			//From state 102 to state 103
			//Eventable{eventType=click, identification=xpath /HTML/BODY/DIV/DIV[2]/FORM/TABLE/TBODY/TR[5]/TD[2]/INPUT, element=Element{node=[INPUT: null], tag=INPUT, text=, attributes={type=submit, value=Ok}}, source=StateVertexImpl{id=102, name=state102}, target=StateVertexImpl{id=103, name=state103}}
			driver.findElement(By.xpath("/HTML/BODY/DIV/DIV[2]/FORM/TABLE/TBODY/TR[5]/TD[2]/INPUT")).click();
			mutateDOMTree();
			...
			//From state 103 to state 98
			//Eventable{eventType=click, identification=xpath /HTML/BODY/DIV/DIV/DIV[2]/DIV[2]/UL/LI[3]/SPAN/A, element=Element{node=[A: null], tag=A, text=Logout, attributes={href=/claroline-1.11.7/index.php?logout=true, target=_top}}, source=StateVertexImpl{id=103, name=state103}, target=StateVertexImpl{id=98, name=state98}}
