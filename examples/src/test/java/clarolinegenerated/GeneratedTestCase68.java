...
public class GeneratedTestCase68 {
	...
	public void method68(){
		try {
			...
			//Eventable{eventType=click, identification=text Support forum, element=Element{node=[A: null], tag=A, text=Support forum, attributes={href=http://forum.claroline.net/}}, source=StateVertexImpl{id=2, name=state2}, target=StateVertexImpl{id=146, name=state146}}
