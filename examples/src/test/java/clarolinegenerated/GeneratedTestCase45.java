...
public class GeneratedTestCase45 {
	...
	public void method45(){
		try {
			...
			//From state 169 to state 109
			//Eventable{eventType=click, identification=text Logout, element=Element{node=[A: null], tag=A, text=Logout, attributes={href=/claroline-1.11.7/index.php?logout=true, target=_top}}, source=StateVertexImpl{id=169, name=state169}, target=StateVertexImpl{id=109, name=state109}}
